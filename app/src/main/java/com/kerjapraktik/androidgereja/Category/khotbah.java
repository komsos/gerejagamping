...
public class khotbah extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    String category = "https://www.gerejagamping.org/wp-json/wp/v2/posts?categories=5&orderby=date&order=desc";
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.berita:
                Intent berita = new Intent(khotbah.this, com.kerjapraktik.androidgereja.berita.class);
                startActivity(berita);
                finish();
                break;
            case R.id.renungan:
                Intent renungan = new Intent(khotbah.this, renungan.class);
                startActivity(renungan);
                finish();
                break;
            case R.id.khotbah:
                Toast.makeText(khotbah.this,"sudah dihalaman",Toast.LENGTH_SHORT).show();
                break;
            case R.id.cerpen:
                Intent cerpen = new Intent(khotbah.this, cerpen.class);
    ...
    void getData(String url2){
        list.clear();
        pd = new ProgressDialog(khotbah.this);
