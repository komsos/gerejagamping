...
public class renungan extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    String category = "https://www.gerejagamping.org/wp-json/wp/v2/posts?categories=10&orderby=date&order=desc";
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.berita:
                Intent berita = new Intent(renungan.this, com.kerjapraktik.androidgereja.berita.class);
                startActivity(berita);
                finish();
                break;
            case R.id.renungan:
                Toast.makeText(renungan.this,"sudah dihalaman",Toast.LENGTH_SHORT).show();
                break;
            case R.id.khotbah:
                Intent khotbah = new Intent(renungan.this, khotbah.class);
                startActivity(khotbah);
                finish();
                break;
            case R.id.cerpen:
                Intent cerpen = new Intent(renungan.this, cerpen.class);
       ...
       void getData(String url2){
           list.clear();
        pd = new ProgressDialog(renungan.this);
