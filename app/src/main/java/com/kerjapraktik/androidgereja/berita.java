...
import com.kerjapraktik.androidgereja.Category.khotbah;
import com.kerjapraktik.androidgereja.Category.renungan;
import com.kerjapraktik.androidgereja.Category.cerpen;
...
public class berita extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    String category = "https://www.gerejagamping.org/wp-json/wp/v2/posts?categories=35&orderby=date&order=desc";
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.berita:
                Toast.makeText(berita.this,"sudah dihalaman",Toast.LENGTH_SHORT).show();break;
            case R.id.renungan:
                Intent renungan = new Intent(berita.this, renungan.class);
                startActivity(renungan);
                finish();
                break;
            case R.id.khotbah:
                Intent khotbah = new Intent(berita.this, khotbah.class);
                startActivity(khotbah);
                finish();
                break;
            case R.id.cerpen:
                Intent cerpen = new Intent(berita.this, cerpen.class);
                startActivity(cerpen);
                finish();
                break;
        }
    }
    ...
    void getData(String url2){
        list.clear();
        pd = new ProgressDialog(berita.this);
